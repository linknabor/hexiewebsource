       ...
       <div v-show="channelOperationInfo">
        <van-radio-group v-model="payMethod" @change="onRadioChange">
            <van-cell-group>
                ...
                <div v-show="showMoreFlag" style="text-align: center;text-align: center;margin-top: 0.2rem;margin-bottom: 0.2rem;"><span @click="handleMore">更多支付方式 </span><van-icon name="arrow-down" /></div>
                ...
                <div v-show="!showMoreFlag" style="text-align: center;text-align: center;margin-top: 0.2rem;margin-bottom: 0.2rem;"><span @click="handleMore">收起 </span><van-icon name="arrow-up" /></div>
            </van-cell-group>
        </van-radio-group>
        <!--选择支付方式 start-->
       </div>
