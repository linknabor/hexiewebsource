...
var MasterConfig = function() {
    var t = {
		...
		ccappid:'wx944c12478a484646',//春川
		hhappid:'wx6dd869dd6935baea',//汇虹
		wdappids: ['wx5b1a7c252c3cbc26'],
        yjappid:'wx263d9873296d7e1c', //宜居家生活
		
		yjMiniForWordUrl:'appid=wx883375a55913b8f0&path=pages/login/register' //wx883375a55913b8f0
	},
...
function Getofficial() {
    ...
    if(userStr) {
        ...
        var wdappid = MasterConfig.C('wdappids')
        if(wdappid.indexOf(appid)>-1) {
            common.newname = '光明悦生活'
        } else {
        		common.newname = '社区'	
        }
    }
...
window.common = {
   ...
   getoriApp:function() {
    ...
    hasRegister:function(){
        return getCookie("UID")&&this.isRegisted();
    },
    ...
    log: function() {
        ...
        o = 0; e > o; o++) if(MasterConfig.C('is_debug')){console.log(arguments[o])}
    },
    alert: function(e) {
