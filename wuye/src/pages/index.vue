...
.footer li {float: left;width: 25%;text-align: center;height: 100%}
...
<template>
    ...
    <footer class="footer">
      <nav>
        <ul>
          <li>
            <a href="https://uat.e-shequ.com/weixin/home/index.html" class="nav-controller">
              <i class="footer_logo footer_home"></i>服务
            </a>
          </li>
          <li>
            <a href="https://uat.e-shequ.com/weixin/group/onsalesindex.html" class="nav-controller">
              <i class="footer_logo footer_temai"></i>集市
            </a>
          </li>
          <li>
            <a href="https://uat.e-shequ.com/weixin/wuye/index.html" class="nav-controller active">
