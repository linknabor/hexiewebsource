<template>
   <div >
     ...
     <div id="indexdivs" @scroll="getscroll">
        <div id="indexDiv">
        <div class="banner" v-for="banner in banners" :key="banner.id" v-if="banner.onSaleType == currentType">
		    <img :src="banner.picture">
	    </div>
        <div v-for="banner in titles" :key="banner.id" v-if="banner.onSaleType == currentType">
