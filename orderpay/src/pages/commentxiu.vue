<template>
   <div>
            <div class="title_area">
                ...
                <div class="brand-tip-2">维修工师傅很辛苦，给个好评呗</div>
            </div>

            <div style="line-height: 35px;">
                    <span class="grade fs15">维修质量：</span>
                    <span style="float: right; margin-right: 10px;">
                        <div  v-for="(itemClass,index) in itemClasses" :class="itemClass" class="star" @click="serverClick(index)"></div>
                    </span>
	        </div>
            ...
            <div style="line-height: 35px;">
                    ...
                    <span style="float: right; margin-right: 10px;">
                        <div  v-for="(itemClass,index) in itemClasses1" :class="itemClass" class="star" @click="serverClick1(index)"></div>
                    </span>
	        </div>
            ...
            <div style="line-height: 35px;">
                    ...
                    <span style="float: right; margin-right: 10px;">
                        <div  v-for="(itemClass,index) in itemClasses2" :class="itemClass" class="star" @click="serverClick2(index)"></div>
                    </span>
	        </div>
            ...
            <div class="photo_area">
                        ...
                        <div v-for="item in photos" class="photo_wrap a_third_m20_height" >
                            <img :src="item.imgUrl" class="photo a_third_m22_height"/>
                            <!-- <img class="photo a_third_m22_height" src="../assets/images/icon_unselect.png" alt=""> -->
                        </div>
   ...
   methods: {
       ...
       serverClick(index) {
        ...
        sendComment() {
            ...
            var add={
                repairId:vm.$route.query.ordersID,
            ...
            vm.receiveData.postData(vm,'/repair/comment',add,'res',function(){
                if(vm.res.success) {
                    // vm.$router.push({path:'/ordersDetail',query:{orderId:vm.$route.query.ordersID}})
                       ...
                       window.location.href=vm.basePageUrl+"person/index.html?state=123#/ordersDetail?orderId="+vm.$route.query.ordersID 
                }else {
                        alert("评论失败，请稍后重试！");
                }
