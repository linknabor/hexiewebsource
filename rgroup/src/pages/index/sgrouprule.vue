<template>
   <div class="sgrooup">
        ...
        <div id="container">
                ...
                <div id="selectImage1" class="subtitleImageClass">
                    <img src="../../assets/images/index/img_rule1 (1).png" />
                </div>
                <div id="selectTitleDiv" class="subTitleClass">选择商品</div>
                <div id="clear"></div>
                <div id="selectImage2" class="bodyImageClass">
                    <img src="../../assets/images/index/img_rule22.png" />
                </div>
                <div id="selectBodyDiv" class="bodyClass">选择心仪的团购商品下单</div>
                <div id="clear"></div>
                <!-- 2 -->
                <div id="payImage1" class="subtitleImageClass">
                    <img src="../../assets/images/index/img_rule1 (1).png" />
                </div>
                <div id="payTitleDiv" class="subTitleClass">支付参团</div>
                <div id="clear"></div>
                <div id="payImage2" class="bodyImageClass">
                    <img src="../../assets/images/index/img_rule22.png" />
                </div>
                <div id="payBodyDiv" class="bodyClass">完成支付后，参团成功</div>
                <div id="clear"></div>
                <!-- 3 -->
                <div id="inviteImage1" class="subtitleImageClass"><img src="../../assets/images/index/img_rule1 (1).png" /></div>
                <div id="inviteTitleDiv" class="subTitleClass">邀请好友参团</div>
                <div id="clear"></div>
                <div id="inviteImage2" class="bodyImageClass"><img src="../../assets/images/index/img_rule22.png" /></div>
                <div id="inviteBodyDiv" class="bodyClass">邀请更多小伙伴来参加团购</div>
                <div id="clear"></div>
                <!-- 4 -->
                <div id="successImage1" class="subtitleImageClass"><img src="../../assets/images/index/img_rule1 (1).png" /></div>
                <div id="successTitleDiv" class="subTitleClass">达到人数参团成功</div>

                <div id="clear"></div>
                <div id="successImage3"><img src="../../assets/images/index/img_rule33.png" /></div>
            <!-- 5 -->
